    ...
    <div class="space-y-6">
        ...
        <div>
            ...
            <nav class="space-y-1">
                ...
                <a href="{{ route('notifikasi') }}" @click="sidebarOpen = false" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-300 {{ request()->routeIs('notifikasi') ? 'bg-primary text-primary-foreground shadow-lg shadow-primary/20' : 'text-muted-foreground hover:bg-secondary hover:text-foreground' }}">
